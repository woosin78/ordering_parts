package org.jwebppy.portal.iv.hq.parts.export.order.display.web;
...
import org.jwebppy.portal.iv.hq.parts.export.order.display.service.ExOrderDisplayService;
...
@Controller
@RequestMapping(PartsExportCommonVo.REQUEST_PATH + "/order/display/inquiry")
public class ExInquiryDisplayController extends PartsExportGeneralController
{
	@Autowired
	private ExOrderDisplayService orderDisplayService;
