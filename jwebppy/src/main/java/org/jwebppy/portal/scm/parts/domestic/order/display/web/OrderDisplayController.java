package org.jwebppy.portal.scm.parts.domestic.order.display.web;
...
@Controller
@RequestMapping("/portal/scm/parts/domestic/order/display")
public class OrderDisplayController extends PartsGeneralController
{
	...
	public Object orderData(@RequestParam Map<String, Object> paramMap)
	{
		...
		FormatBuilder.with(dataList)
			.dateFormat("ERDAT")
			.dateFormat("ERZET", ScmCommonVo.DEFAULT_TIME_MMHH_FORMAT);
