...
import org.jwebppy.portal.dbkr.scm.parts.domestic.order.dto.OrderHistoryItemDto;
...
import org.jwebppy.portal.dbkr.scm.parts.domestic.order.mapper.OrderCreateMapper;
...
public class OrderCreateService
{
	...
	{
		if (CollectionUtils.isEmpty(orderCreateMapper.findAllOnetimeAddressDuplicationCheck(onetimeAddress)))
		{
			return false;
		}
	...
	{
		return CmModelMapperUtils.mapAll(orderCreateMapper.findAllOnetimeAddressDuplicationCheck(onetimeAddress), OnetimeAddressDto.class);
	}
