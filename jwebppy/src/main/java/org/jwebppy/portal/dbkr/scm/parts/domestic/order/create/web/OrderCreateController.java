package org.jwebppy.portal.dbkr.scm.parts.domestic.order.create.web;
...
import org.jwebppy.portal.dbkr.scm.parts.domestic.order.create.dto.OnetimeAddressDto;
import org.jwebppy.portal.dbkr.scm.parts.domestic.order.create.dto.OrderDto;
import org.jwebppy.portal.dbkr.scm.parts.domestic.order.create.dto.OrderItemDto;
import org.jwebppy.portal.dbkr.scm.parts.domestic.order.create.service.OrderCreateService;
...
@Controller
@RequestMapping("/portal/dbkr/scm/parts/domestic/order/create")
public class OrderCreateController extends PartsGeneralController
{
	...
	{
		String[] materialNos = CmStringUtils.split(order.getMaterialNo(), DbkrCommonVo.DELIMITER);
	...
	public Object save(@ModelAttribute OrderDto order)
	{
		if (CmStringUtils.isNotEmpty(order.getMaterialNo()))
		{
			...
			String[] lineNos = CmStringUtils.splitPreserveAllTokens(order.getLineNo(), DbkrCommonVo.DELIMITER);
			String[] materialNos = CmStringUtils.splitPreserveAllTokens(order.getMaterialNo(), DbkrCommonVo.DELIMITER);
			String[] orderQtyies = CmStringUtils.splitPreserveAllTokens(order.getOrderQty(), DbkrCommonVo.DELIMITER);
			String[] lotQties = CmStringUtils.splitPreserveAllTokens(order.getLotQty(), DbkrCommonVo.DELIMITER);
			String[] uoms = CmStringUtils.splitPreserveAllTokens(order.getUom(), DbkrCommonVo.DELIMITER);
			String[] availabilities = CmStringUtils.splitPreserveAllTokens(order.getAvailability(), DbkrCommonVo.DELIMITER);
