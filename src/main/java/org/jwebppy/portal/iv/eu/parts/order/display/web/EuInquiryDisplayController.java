package org.jwebppy.portal.iv.eu.parts.order.display.web;
...
import org.jwebppy.portal.iv.eu.parts.order.display.service.EuOrderDisplayService;
...
public class EuInquiryDisplayController extends OrderGeneralController
{
	@Autowired
	private EuOrderDisplayService orderDisplayService;

	@RequestMapping("/inquiry_list")
	public String inquiryList(Model model, WebRequest webRequest)
	{
	...
	@ResponseBody
	public Object inquiryData(@RequestParam Map<String, Object> paramMap)
	{
	...
	public Object inquiryDetail(@RequestParam Map<String, Object> paramMap, Model model, WebRequest webRequest)
	{
		addAllAttributeFromRequest(model, webRequest);
	...
	@RequestMapping("/inquiry_detail/data")
	@ResponseBody
	public Object inquiryDetailData(@RequestParam Map<String, Object> paramMap)
	{
		ErpDataMap rfcParamMap = getErpUserInfo();
