...
import org.jwebppy.portal.iv.eu.parts.order.create.service.EuOrderCreationService;
...
public class EuOrderCreationController extends OrderGeneralController
{
	...
	public Object headerInfo(@RequestParam Map<String, Object> paramMap)
	{
		...
		return euOrderCreationService.getHeaderInfo(rfcParamMap);
	}
...
//		}
		...
		if (CmStringUtils.isNotEmpty(order.getMaterialNo()))
		{
			...
			RfcResponse rfcResponse = euOrderCreationService.save(order);
	...
	public Object shipToPartyListData(@RequestParam Map<String, Object> paramMap)
	{
		...
		return euOrderCreationService.getShipToParty(rfcParamMap);
	}
	...
	public Object shippingInfoListData(@RequestParam Map<String, Object> paramMap)
	{
		...
		return euOrderCreationService.getShippingInfo(rfcParamMap);
	}
	...
	public Object saveTransferOrder(@RequestParam Map<String, Object> paramMap)
	{
		...
		RfcResponse rfcResponse = euOrderCreationService.transferOrder(rfcParamMap);
	...
	@ResponseBody
	public Object validCheck(@ModelAttribute EuOrderDto order)
	{
		...
		return euOrderCreationService.checkValidPartsToOrder(order);
	}
}
