package org.jwebppy.portal.iv.uk.parts.domestic.order.invoice.service;
...
@Service
public class UkInvoiceStatusService extends UkPartsDomesticGeneralService
{
	@Cacheable(value = RedisConfig.INVOICE_STATUS, key = "#paramMap", unless="#result == null")
