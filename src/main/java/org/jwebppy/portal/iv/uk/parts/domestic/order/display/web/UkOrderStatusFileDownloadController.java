...
import org.jwebppy.portal.iv.uk.parts.domestic.order.display.service.UkOrderStatusService;
...
@Controller
@RequestMapping(UkPartsDomesticCommonVo.REQUEST_PATH + "/order/display/order_status")
public class UkOrderStatusFileDownloadController extends UkOrderGeneralController
{
	@Autowired
	private UkOrderStatusService orderStatusService;
	...
	public void excelDownload(@RequestParam Map<String, Object> paramMap, HttpServletResponse httpServletResponse) throws JsonParseException, JsonMappingException, IOException
	{
		...
		.dateFormat(new String[] {"BUDAT","ZEXDT"}, UkCommonVo.DEFAULT_DATE_FORMAT)
		.dateFormat("AUDAT", UkCommonVo.DEFAULT_DATE_FORMAT)
		.dateFormat("FST_ETD", UkCommonVo.DEFAULT_DATE_FORMAT)
		.dateFormat("LST_ETD", UkCommonVo.DEFAULT_DATE_FORMAT);
